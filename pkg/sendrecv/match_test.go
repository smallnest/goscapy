...
func TestDefaultMatchICMPMatch(t *testing.T) {
	...
	_ = replyIP.Set("src", net.ParseIP("8.8.8.8"))
	_ = replyIP.Set("dst", net.ParseIP("10.0.0.1"))
	replyICMP := layers.NewICMP()
	_ = replyICMP.Set("type", uint8(0)) // Echo Reply
	_ = replyICMP.Set("id", uint16(0x1234))
	_ = replyICMP.Set("seq", uint16(1))
...
func TestDefaultMatchICMPWrongID(t *testing.T) {
	...
	_ = replyIP.Set("src", net.ParseIP("8.8.8.8"))
	replyICMP := layers.NewICMP()
	_ = replyICMP.Set("type", uint8(0))
	_ = replyICMP.Set("id", uint16(0x5678)) // different id
	reply := packet.NewFrom(replyIP, replyICMP)
...
func TestDefaultMatchICMPWrongSrc(t *testing.T) {
	sent := buildICMPPacket("8.8.8.8", 0x1234, 1)
	replyIP := layers.NewIP()
	_ = replyIP.Set("src", net.ParseIP("1.1.1.1")) // not the sent dst
	replyICMP := layers.NewICMP()
	_ = replyICMP.Set("type", uint8(0))
	_ = replyICMP.Set("id", uint16(0x1234))
	reply := packet.NewFrom(replyIP, replyICMP)
...
func TestDefaultMatchICMPNotEchoReply(t *testing.T) {
	...
	_ = replyIP.Set("src", net.ParseIP("8.8.8.8"))
	replyICMP := layers.NewICMP()
	_ = replyICMP.Set("type", uint8(13)) // Timestamp, neither Echo Reply nor error
	_ = replyICMP.Set("id", uint16(0x1234))
	reply := packet.NewFrom(replyIP, replyICMP)
...
func TestDefaultMatchTCPMatch(t *testing.T) {
	...
	_ = reply.GetLayer("TCP").Set("ack", uint32(1001))
...
func TestDefaultMatchTCPWrongAck(t *testing.T) {
	...
	_ = reply.GetLayer("TCP").Set("ack", uint32(999)) // wrong ack
...
func buildARPPacket(op uint16, psrc, pdst string) *packet.Packet {
	arp := layers.NewARP()
	_ = arp.Set("op", op)
	_ = arp.Set("psrc", net.ParseIP(psrc))
	_ = arp.Set("pdst", net.ParseIP(pdst))
...
func buildDHCPPacket(op uint8, xid uint32) *packet.Packet {
	...
	_ = dhcpLayer.Set("op", op)
	_ = dhcpLayer.Set("xid", xid)
...
func TestDefaultMatchICMPDestUnreach(t *testing.T) {
	...
	_ = replyIP.Set("src", net.ParseIP("8.8.8.8"))
	replyICMP := layers.NewICMP()
	_ = replyICMP.Set("type", uint8(3)) // Dest Unreachable
	reply := packet.NewFrom(replyIP, replyICMP)
...
func TestDefaultMatchICMPTimeExceeded(t *testing.T) {
	...
	sent := buildICMPPacket("8.8.8.8", 0x1234, 1)
	replyIP := layers.NewIP()
	_ = replyIP.Set("src", net.ParseIP("8.8.8.8")) // from target or router on path
	replyICMP := layers.NewICMP()
	_ = replyICMP.Set("type", uint8(11)) // Time Exceeded
	reply := packet.NewFrom(replyIP, replyICMP)
