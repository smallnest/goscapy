...
func (b *DNSBuilder) Questions(qs []dns.DNSQuestion) *DNSBuilder {
	_ = b.layer.Set("qdcount", uint16(len(qs)))
	_ = b.layer.Set("data", dns.BuildDNSMessage(qs, nil, nil, nil))
	return b
}
...
func (b *DHCPBuilder) MessageType(mt uint8) *DHCPBuilder {
	...
	_ = b.layer.Set("options", dhcp.BuildDHCPOptions(opts))
	return b
}
...
func (b *TLSBuilder) Handshake(hsType uint8, body []byte) *TLSBuilder {
	_ = b.layer.Set("content_type", uint8(layerstls.ContentTypeHandshake))
	...
	copy(frag[4:], body)
	_ = b.layer.Set("fragment", frag)
	return b
}

// Alert sets the fragment to a TLS alert message.
func (b *TLSBuilder) Alert(level, desc uint8) *TLSBuilder {
	_ = b.layer.Set("content_type", uint8(layerstls.ContentTypeAlert))
	_ = b.layer.Set("fragment", []byte{level, desc})
	return b
}
